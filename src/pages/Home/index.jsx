        ...
        <div className="home">
            <div className="home-container">
                <section className="home-hero home-section">
                    <img src="/assets/images/circle%20half.png" className="home-circle-one" alt="half"/>
                    <img src="/assets/images/Ellipse%202.png" className="home-circle-two" alt="Ellipse"/>
                    <div className="home-hero-body">
                        <div className="home-hero-split split-item">
                            <div className="home-hero-split-left">
                                <img src="/assets/images/3d-5.png" className="home-hero-image-3" alt="home-3"/>
                                <br/>
                                <div>
                            ...
                            <div className="home-hero-split-right split-item">
                ...
                <section className="home-images home-section">
                    <div className="home-images-body">
                        <img src="/assets/images/3d-2.png" alt="ss" className="home-images-image-3"/>
